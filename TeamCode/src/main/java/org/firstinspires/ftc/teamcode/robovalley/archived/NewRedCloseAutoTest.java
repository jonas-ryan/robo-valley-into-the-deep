...
@Autonomous(name="NewRedCloseAutoTest")
@Disabled
public class NewRedCloseAutoTest extends LinearOpMode {
    @Override
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(10, 5, Math.toRadians(90))).
                strafeTo(new Vector2d(10, 18)).
                waitSeconds(1);

        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(10, 18, Math.toRadians(90))).
                waitSeconds(0.5).
        ...
        TrajectoryActionBuilder tab4 = drive.actionBuilder(new Pose2d(-10, 6, Math.toRadians(90))).
                ...
                strafeTo(new Vector2d(-30,52)).
                strafeTo(new Vector2d(-39,52)).
                strafeTo(new Vector2d(-39,5)).
                strafeTo(new Vector2d(-39,52)).
