...
@TeleOp(name="Field Centric", group="Mecanum Drive")
//@Disabled
public class MecanumDriveFieldCentric extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            boolean controlResetDirection = gamepad1.right_bumper;
            ...
            double rotatedLateral = controlLateral * Math.cos(-robotHeading) - controlAxial * Math.sin(-robotHeading);
            double rotatedAxial = controlLateral * Math.sin(-robotHeading) + controlAxial * Math.cos(-robotHeading);

            double leftFrontPower = rotatedAxial + rotatedLateral + controlYaw;
            double leftBackPower = rotatedAxial - rotatedLateral + controlYaw;
            double rightBackPower = rotatedAxial + rotatedLateral - controlYaw;
            double rightFrontPower = rotatedAxial - rotatedLateral - controlYaw;
            ...
            if (currentSlideHeight == slideHeight.DONE) {
                ...
                } else if (backSlide.getCurrentPosition() < 270 && controlVerticalSlide < 0 && !controlSlideOverride) {
                    backSlide.setPower(0);
                    frontSlide.setPower(0);
