...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1852.9906496235842; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1775.0125284187789; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3504.387630723133; // x position of the perpendicular encoder (in tick units)
    }
