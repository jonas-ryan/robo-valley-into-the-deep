...
public class Observation3Sample extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // PUSH SAMPLE(S) IN AND TURN AROUND
            Actions.runBlocking(drive.actionBuilder(new Pose2d(-13, 30.5, Math.toRadians(90)))
                    .afterTime(0.4, verticalSlides.verticalSlidesDownWall())
                    .strafeToLinearHeading(new Vector2d(22,16), Math.toRadians(90))
            ...
            Actions.runBlocking(drive.actionBuilder(new Pose2d(36, 20, Math.toRadians(270)))
                    ...
                    .afterTime(1.0, verticalSlides.verticalSlidesUpChamber2())
                    .afterTime(0.9, intake.intakeStop())
                    .strafeToLinearHeading(new Vector2d(36,9.5), Math.toRadians(270))
                    .build());

            // SCORE SPECIMEN
            Actions.runBlocking(drive.actionBuilder(new Pose2d(36, 9.5, Math.toRadians(270)))
            ...
            // INTAKE FROM WALL
            Actions.runBlocking(drive.actionBuilder(new Pose2d(-10, 27, Math.toRadians(90)))
                    .afterTime(0.0, verticalSlides.verticalSlidesDownWall())
                    .afterTime(3.0, perpendicularSlide.perpendicularSlideOut())
                    .afterTime(3.0, verticalSlides.verticalSlidesUpWall3())
                    .afterTime(3.0, intake.intakeIntake())
                    .afterTime(3.8, intake.intakeStop())
                    .strafeToLinearHeading(new Vector2d(36,11), Math.toRadians(270))
                    .build());

            // SCORE SPECIMEN
            Actions.runBlocking(drive.actionBuilder(new Pose2d(36, 11, Math.toRadians(270)))
                    .afterTime(0.0, perpendicularSlide.perpendicularSlideIn())
                    .afterTime(0.0, verticalSlides.verticalSlidesUpChamber3())
                    .afterTime(3.0, verticalSlides.verticalSlidesDownScore())
                    .afterTime(3.4, intake.intakeOuttake())
                    .afterTime(3.8, intake.intakeStop())
                    .strafeToLinearHeading(new Vector2d(-6,30), Math.toRadians(90))
                    .build());

            Actions.runBlocking(drive.actionBuilder(new Pose2d(-6, 30, Math.toRadians(90)))
                    .afterTime(0.0, perpendicularSlide.perpendicularSlideIn())
